  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        spectral: ['Inter', 'system-ui', 'sans-serif'],
        lora: ['Inter', 'system-ui', 'sans-serif'],
        source: ['Inter', 'system-ui', 'sans-serif'],
        merriweather: ['Inter', 'system-ui', 'sans-serif'],
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, rgba(10, 66, 80, 0.3) 0%, rgba(26, 90, 107, 0.2) 50%, rgba(10, 66, 80, 0.3) 100%)',
        'gradient-overlay': 'linear-gradient(180deg, rgba(0,0,0,0.05) 0%, rgba(0,0,0,0.15) 50%, rgba(0,0,0,0.3) 100%)',
